...
void assignment1() {
  ...
  userProfile = 'userProfile : Mohanad Alnahdi';
  print(userProfile);
...
void assignment5() {
  ...
  //Task 1
  List<String> employees = ["Ali", "Omar"];
  employees.add("Sara");
...
void assignment7() {
  ...
  //Task 1
  var location = ("Jeddah", 39.1925, 21.4858);
...
void assignment10() {
  ...
  String nonNullableName = "Mohanad";
...
Future<void> main() async {
  ...
  registerUser(username:'Mohanad',email:'moha@gamil.com',age:25);
  print(counter);
  increaseCounter();
  print(counter);
  print(isPositive(5));
  ...
  print('------------------------');
  print('Assignment 12');
  Manager manager = Manager("Mohanad", 9000, 5);
  manager.displayInfo();
  print('');
